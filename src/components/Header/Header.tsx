...
export default function Header() {
  ...
  return (
    <div className='pt2 bg-[linear-gradient(-180deg,#f53d2d,#f63)] pb-5  text-white '>
            ...
            >
              <div className='mr-2 h-6 w-6 flex-shrink-0'>
                <img
                  ...
                  alt='avatar'
                  className='object-over h-full w-full rounded-full'
                />
              </div>
        ...
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          ...
          <form className='col-span-9'>
            <div className='flex rounded-sm bg-white p-1'>
              ...
              />
              <button className='rouded-sm flex-shink-0 hover: bg-orange px-6 py-2 opacity-90'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
                ...
                <div className='relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                  <div className='p-2'>
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://down-vn.img.susercontent.com/file/sg-11134201-7qvcs-lf6n8xk4q59rc1_tn'
                            alt='anh'
                            className='h-11 w-11 object-cover'
                          />
                        </div>
                        <div className='ml-2 flex-grow overflow-hidden'>
                          <div className='truncate'>Dép Lê Đế Xuồng Chống Trượt Thoải Mái Thời Trang Cho Nam</div>
                        </div>
                        <div className='ml2 flex-shrink-0'>
                          <span className='text-orange'>₫51.000</span>
                        </div>
                      </div>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                    ...
                    <div className='mt-6 flex items-center justify-between'>
                      ...
                      <button className='rouded-sm bg-orange px-4 py-2 capitalize text-white hover:bg-opacity-90'>
                        Xem giỏ hàng
                      </button>
                    </div>
                  </div>
